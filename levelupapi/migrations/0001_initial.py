# Generated by Django 3.2.9 on 2021-11-01 20:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attending_events', models.ManyToManyField(related_name='attendees', through='levelupapi.EventGamer', to='levelupapi.Event')),
